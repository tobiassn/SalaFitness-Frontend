...
function Dashboard({onLogout, onNavigateToProfile, onNavigateToAdminGyms, onNavigateToSubscriptions, onNavigateToTrainers, onNavigateToAppointments,onNavigateToAdminUsers}){
